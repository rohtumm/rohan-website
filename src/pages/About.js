    ...
    <div className="hero-container" style={{ minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '32px 20px', position: 'relative', zIndex: 2, textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '1.2em', color: '#444', lineHeight: 1.7}}>
            I'm a current freshman at UC Berkeley interested interested in AI and machine learning, applied mathematics, and using data to solve real-world problems—especially in sports and healthcare. I love building things that combine technology and creativity, and I'm always looking for new ways to learn. <br />
            <br />
